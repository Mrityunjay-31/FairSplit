...
function CircularScore({ score, color, delay }) {
  ...
  return (
    <svg ref={ref} width="120" height="120" viewBox="0 0 120 120" className="score-ring">
      {/* Track */}
      ...
      />
      {/* Text */}
      <text x="60" y="64" textAnchor="middle" fill="var(--text-primary)" fontSize="22" fontWeight="800" fontFamily="Inter, sans-serif">
        {score}
      </text>
    </svg>
  )
